docker run --name umi_nea -v ${PWD}:/home/qiauser -v ~/support/Song/TCR_V3/PBMC_reproducibility:/data -w /home/qiauser qiaseqresearch/umi-nea:v2 bash -c "bash /Download/UMI-nea/benchmark/TCR_data/PBMC_7_clonotypes/cluster_with_umi-tools.sh"
docker rm umi_nea
cd M06463_0121new/
