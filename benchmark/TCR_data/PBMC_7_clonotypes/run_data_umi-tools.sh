docker run --name clono7 -v ${PWD}:/home/qiauser -v ~/support/UMI-nea_paper/PBMC_reproducibility_UMI-nea/:/data -w /home/qiauser qiaseqresearch/umi-nea:v3 bash -c "bash /Download/UMI-nea/benchmark/TCR_data/PBMC_7_clonotypes/cluster_with_umi-tools.sh"
docker rm clono7
cd M06463_0121new/
