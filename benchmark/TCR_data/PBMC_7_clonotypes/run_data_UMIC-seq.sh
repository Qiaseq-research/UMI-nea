docker run --name clono7 -v ${PWD}:/home/qiauser -v ~/support/UMI-nea_paper/PBMC_reproducibility_UMI-nea/:/data -w /home/qiauser umi-nea:latest bash -c "bash /Download/UMI-nea/benchmark/TCR_data/PBMC_7_clonotypes/cluster_with_UMIC-seq.sh 0 2"
docker rm clono7
cd M06463_0121new/
